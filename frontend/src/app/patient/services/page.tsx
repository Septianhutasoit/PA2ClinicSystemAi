...
export default function PatientServicesPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 font-sans selection:bg-blue-100">
            ...
            {/* ============================================================ */}
            {/* HERO SECTION - SMOOTH ZOOM TANPA GOYANG */}
            {/* ============================================================ */}
            <section
                ref={sectionRef}
            ...
            >
                {/* Background Image Container - ZOOM SMOOTH */}
                <div className="absolute inset-0 overflow-hidden">
                    <motion.div
                        ...
                        transition={{
                            duration: 4,
                            ease: [0.25, 0.1, 0.25, 1], // Cubic bezier yang sangat halus
                            repeat: isHovering ? Infinity : 0,
                            repeatType: "reverse",
                            repeatDelay: 0,
                        }}
                        style={{
                            backgroundImage: "url('/images/layanan.jpg')",
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-16">
                    <div className="max-w-md">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-md px-2.5 py-1 rounded-full border border-white/20 mb-3"
                        >
                            <Sparkles size={8} className="text-blue-400" />
                            <span className="text-[7px] font-bold uppercase tracking-[0.15em] text-white/80">
                                Nauli Dental Care
                            </span>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            className="text-white/50 text-[11px] leading-relaxed mb-4 max-w-sm"
                        >
                        ...
                        >
                            <Link
                                ...
                                className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-full font-bold text-[8px] uppercase tracking-wider transition-all flex items-center gap-1 shadow-lg shadow-blue-500/30"
                            >
                                Pesan Sekarang
                                <ArrowRight size={8} />
                            </Link>
                            <a
                                href="#services"
                                className="bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white px-3 py-1.5 rounded-full font-bold text-[8px] uppercase tracking-wider transition-all flex items-center gap-1"
                            >
                                <Stethoscope size={8} />
                                Lihat Katalog
                            </a>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
                    {stats.map((stat, idx) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8 }}
                            className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl shadow-black/5 border border-white/50 text-center group transition-all duration-300"
                        >
            ...
            <section className="max-w-7xl mx-auto px-6 py-24">
                ...
                >
                    <span className="text-blue-600 font-black text-xs uppercase tracking-[0.2em] bg-blue-50 px-4 py-2 rounded-full inline-block">
                        Mengapa Memilih Kami
                    </span>
                    <h2 className="text-3xl md:text-5xl font-black text-slate-800 mt-4 italic tracking-tight">
                        Keunggulan <span className="text-blue-600">Layanan</span> Kami
                    </h2>
                    <p className="text-slate-500 max-w-2xl mx-auto mt-3">
                        Kami memberikan pelayanan terbaik dengan teknologi modern dan tenaga profesional
                    </p>
                </motion.div>
            ...
            <section id="services" className="py-16 px-6 max-w-7xl mx-auto">
                ...
                >
                    <span className="text-emerald-600 font-black text-xs uppercase tracking-[0.3em] bg-emerald-50 px-4 py-2 rounded-full inline-block">
                        Daftar Perawatan
                    </span>
                    ...
                    <p className="text-slate-500 max-w-2xl mx-auto">
                        Setiap layanan kami telah terverifikasi dan ditangani oleh dokter spesialis
                    </p>
                </motion.div>
                ...
                {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                        ...
                        <p className="font-black text-slate-400 uppercase tracking-widest text-xs">Memuat layanan...</p>
                    </div>
                ) : services.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((item: any, idx: number) => (
                            <motion.div
                                ...
                                transition={{ delay: idx * 0.1 }}
                                whileHover={{ y: -10 }}
                                className="group bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-blue-200/50 transition-all duration-500"
                            >
                                <div className="relative h-56 overflow-hidden">
                                    <img
                                        src={item.image_url || 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?q=80&w=1974&auto=format&fit=crop'}
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex items-center gap-4 pt-4 border-t border-slate-100">
                                        ...
                                        <div className="flex items-center gap-1.5">
                                            ...
                                            <span className="text-xs text-slate-500">Garansi</span>
                                        </div>
                                    </div>
                    ...
                    <div className="text-center py-20">
                        <Stethoscope size={60} className="mx-auto text-slate-200 mb-4" />
                        <h3 className="text-xl font-black text-slate-400 uppercase tracking-widest">Belum Ada Layanan Tersedia</h3>
                    </div>
                )}
            </section>
            ...
            <section className="max-w-7xl mx-auto mt-10 mb-20 px-6">
                <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl shadow-2xl"
                >
                    <div className="absolute inset-0 opacity-10">
                        <div className="absolute top-0 right-0 w-80 h-80 bg-blue-500 rounded-full blur-3xl" />
                        <div className="absolute bottom-0 left-0 w-80 h-80 bg-emerald-500 rounded-full blur-3xl" />
                    </div>
                    <div className="relative z-10 p-10 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div className="text-center md:text-left">
                            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-wider text-white">AI Assistant 24/7</span>
                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-wider shadow-xl transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
                                <Sparkles size={16} />
                                Buka Chatbot AI
                            </button>
                            <button className="bg-white/10 backdrop-blur-sm border border-white/20 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold text-xs uppercase tracking-wider transition-all flex items-center gap-2">
                                <Phone size={16} />
                                Call Center
                            </button>
                        </div>
